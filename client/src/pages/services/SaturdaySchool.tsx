  ...
  const serviceCategories: ServiceCategory[] = [
    {
      ...
      items: [
        {
          id: "revision",
          text: "Weekly revision sessions for consistent learning"
        },
        {
          id: "support",
          text: "Focused support in challenging subjects"
        },
        {
          id: "learning",
          text: "Group learning with individual attention"
        },
        {
          id: "tracking",
          text: "Ongoing progress tracking and feedback"
        }
      ]
    },
    {
      title: "Why Join Saturday School",
      items: [
        {
          id: "confidence",
          text: "Boost confidence and exam readiness"
        },
        {
          id: "grades",
          text: "Improve grades through consistent practice"
        },
        {
          id: "habits",
          text: "Develop stronger study habits"
        },
        {
          id: "environment",
          text: "Access a supportive learning environment"
        }
      ]
    }
  ];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <header className="text-center mb-12">
          ...
          <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
            Saturdays are for building success. JD Tutoring's Saturday classes give learners the chance 
            to catch up, stay ahead, and strengthen their understanding of key subjects.
          </p>
        </header>
        ...
        <section className="mt-12 text-center" aria-labelledby="cta-heading">
          <h2 id="cta-heading" className="sr-only">Register for Saturday School</h2>
          <Button 
            ...
            aria-label="Navigate to registration page for Saturday School"
          >
            Register Now
          </Button>
        </section>
